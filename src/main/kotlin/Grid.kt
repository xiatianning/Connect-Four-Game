...
class Grid(width: Int, height: Int, private val length: Int) {
    ...
    /**
     * Attempts to drop a piece in a certain column. If a piece can be successfully dropped, the function returns that [Piece].
    ...
    fun dropPiece(column: Int, player: Player): Piece? {
        ...
        grid.setCell(column, row - 1, player)  // set ownership for piece the furthest down in the column
